            ...
            {[
              [
                ...
                },
                {
                  year: 2006,
                  list: [
                    "06. ‘세상의 중심에서 나눔을 외치다’ 봉사 캠페인 주최 및 주관",
                  ],
                },
                {
                  year: 2007,
                  list: [
                    "01. ‘제3회 전국고교 학생회장 토론회 및 리더십연수’ 주최 및 주관",
                  ],
                },
                {
                  year: 2008,
                ...
                },
                {
                  year: 2009,
                  list: [
                    "03. ‘제5회 전국고교 학생회장 토론회 및 리더십연수’ 주최 및 주관",
                  ],
                },
                {
                  year: 2010,
              ...
              [
                ...
                },
                {
                  year: 2013,
                  list: [
                    "03. ‘제9회 전국고교 학생회장 토론회 및 리더십연수’ 주최 및 주관",
                  ],
                },
                {
                  year: 2014,
              ...
              [
                ...
                },
                {
                  year: 2023,
                  list: [
                    "02. ‘제5회 학생회 정보 교류의 장 -  비정상자치’ 주최 및 주관",
                  ],
                },
                {
                  year: 2024,
                  list: [
                    "01. ‘제6회 학생회 정보 교류의 장 - 태어난 김에 학생자치’ 주최 및 주관",
                  ],
                },
                {
                  year: 2025,
                  list: [
                    "01. ‘청소년 리더 대담회 : 더 비전 2025’ 주최 및 주관",
                  ],
                },
                {
                  year: 2026,
                  list: ["01. ‘우리[:RE] 같이, 학생자치’ 주최 및 주관"],
                },
              ],
              "icon",
            ].map((historyList, idx) => {
              ...
              return (
                <div className="flex gap-2 md:gap-3 lg:gap-4" key={idx}>
